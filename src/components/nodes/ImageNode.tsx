      ...
      <div className="p-2.5 space-y-2" onMouseDown={(e) => e.stopPropagation()}>
        {imageAdvancedProviders.length > 0 && (
          <div className="rounded border border-white/10 bg-white/[0.03] p-2 space-y-2">
            ...
            >
              <span>高级来源</span>
              <span>{isExternalSelected && providerSelection.provider ? providerSelection.provider.label : '默认雪糕工坊'}</span>
            </button>
            {d?.advancedProviderOpen && (
              <div className="space-y-2">
                <div>
                  ...
                  >
                    <option value="zhenzhen" style={{ background: '#18181b', color: '#ffffff' }}>雪糕工坊（默认）</option>
