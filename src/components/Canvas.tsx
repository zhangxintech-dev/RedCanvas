      ...
      >
        <div className="text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <img src="/logo.png" alt="RedCanvas" className="w-12 h-12 object-contain" />
            <span className="text-2xl font-bold tracking-wide">RedCanvas</span>
          </div>
          <p>请先在左侧创建或选择一个画布</p>
        </div>
      </div>
